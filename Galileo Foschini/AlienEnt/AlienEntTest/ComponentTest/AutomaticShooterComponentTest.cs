...
{
    [TestClass]
    public class AutomaticShooterComponentTest
    {
        ...
        public AutomaticShooterComponentTest()
        {
        ...
        {
            AutomaticShooterComponent shooterComponent = new(_ship, true, _supplier);
